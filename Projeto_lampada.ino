...
const char* mqttServer = "hairdresser.cloudmqtt.com"; //Server disponibilizado pela instância do CloudMQTT
const int mqttPort =  15501; //Porta disponibilizado pela instância do CloudMQTT
const char* mqttUser = "lcflwrnr"; //Usuário disponibilizado pela instância do CloudMQTT
const char* mqttPassword = "TsfavFov39nP"; //Senha disponibilizado pela instância do CloudMQTT
const char* mqttTopicSub ="lampada";   //Tópico voce pode escolher um nome
